<template>
    <a href="https://tailwindui.com/components#product-application-ui">https://tailwindui.com/components#product-application-ui</a>
    ...
    <li>
      <div class="relative pb-8">
        ...
        <div class="relative flex space-x-3">
          ...
          <div class="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
            <div>
              <p class="text-sm text-gray-500 dark:">Advanced to phone screening by <a href="#" class="font-medium text-gray-900">Bethany Blake</a></p>
            </div>
            <div class="whitespace-nowrap text-right text-sm text-gray-500">
